...
-- Insert sample organisers (removed explicit organiser_id since it's SERIAL)
INSERT INTO public.organiser (site_user_id, name, email)
VALUES 
(2, 'Event Masters Inc.', 'contact@eventmasters.com'),
(4, 'Conference Professionals', 'info@confpro.com');
...
-- Insert sample events (using the auto-generated organiser_ids from above)
-- Assuming first organiser got id=1 and second got id=2
